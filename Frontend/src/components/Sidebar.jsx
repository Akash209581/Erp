...
const Sidebar = ({ user, onLogout }) => {
  ...
  const menuItems = [
    ...
    { title: 'Hostel Management', icon: <Building2 size={20} />, path: '/hostel-management', roles: ['student'] },
    ...
    { title: 'Library', icon: <Library size={20} />, path: '/library', roles: ['student'] },
    ...
    { title: 'My Transportation', icon: <Bus size={20} />, path: '/my-transportation', roles: ['student'] },
