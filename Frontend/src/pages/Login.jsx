      ...
      <div className="max-w-[480px] w-full">
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_-20px_rgba(15,23,42,0.1)] border border-slate-100 p-10 md:p-14 relative overflow-hidden">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-600 rounded-3xl mb-8 shadow-xl shadow-blue-600/20 rotate-3 ring-4 ring-blue-50">
              <span className="text-white font-black text-3xl italic">U</span>
            </div>
            <h1 className="text-[32px] font-black tracking-tight text-slate-900 leading-tight">Welcome Back</h1>
            <p className="text-slate-500 font-medium mt-3">Access the university management portal</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <div className="flex items-center gap-3 p-4 bg-red-50 text-red-600 rounded-2xl text-sm font-semibold border border-red-100 animal-shake">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-14 pr-5 py-5 bg-slate-50 border-2 border-slate-50 rounded-2xl text-slate-900 font-semibold placeholder:text-slate-300 focus:bg-white focus:border-blue-500/20 focus:ring-4 focus:ring-blue-500/5 transition-all outline-none"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 py-5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white font-black rounded-2xl transition-all duration-300 shadow-xl shadow-blue-600/25 active:scale-[0.98]"
            >
              {isLoading ? (
